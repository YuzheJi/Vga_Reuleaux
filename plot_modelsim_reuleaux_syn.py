...
def reuleaux_triangle_to_txt(color, centre_x, centre_y, diameter, filename="../reuleaux_syn_python.txt"):
    x_min, x_max = 0, 159
    y_min, y_max = 0, 119
...
def plot_results(color, centre_x, centre_y, diameter):
    ...
    [points1, black_count, clk] = read_points_from_txt("../reuleaux_syn_verilog.txt")
    [points2, hhh, hhhh] = read_points_from_txt("../reuleaux_syn_python.txt")
    ...
    plt.savefig("./Result_reu_syn.png")  

    image_path = os.path.abspath("./Result_reu_syn.png")
